...
<body>
    ...
    <div class="container">
        ...
        <form action="user.php" method="post">
            ...
            <div class="form-group">
                <input type="text" name="User_name" id="User_name" placeholder="Enter your User_name: ">
            </div>
            <div class="form-group">
                <input type="text" name="User_phoneno" id="User_phoneno" placeholder="Enter your Phone number: ">
            </div>
            <div class="form-group">
                <input type="text" name="User_address" id="User_address" placeholder="Enter your Address: ">
            </div>
            <div class="form-group">
                <input type="text" name="User_email" id="User_email" placeholder="Enter your Email-ID:">
            </div>
    ...
    if ($conn->connect_error) {
        ...
        $stmt = $conn->prepare("insert into user(User_ID, User_name, User_phoneno, User_address, User_email) values(?, ?, ?, ?, ?)");
        $stmt->bind_param("ssiss", $User_ID, $User_name, $User_phoneno, $User_address, $User_email);
        $stmt->execute();
